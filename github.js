class Github {
    ...
    getUser = async (user) => {
        ...
        // const profileResponse = await fetch(`https://api.github.com/users/gowthaman-01`);
        // const repoResponse = await fetch(`https://api.github.com/users/gowthaman-01/repos?per_page=5`);
